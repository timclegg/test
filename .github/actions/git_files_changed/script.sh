...
echo "all_files_changed: `git diff --name-only HEAD~$INPUT_NUMBER_COMMITS_BACK..HEAD`"
echo "::set-output name=all_files_changed::`git diff --name-only HEAD~$INPUT_NUMBER_COMMITS_BACK..HEAD`"

echo "added_files: `git diff --name-only --diff-filter=A HEAD~$INPUT_NUMBER_COMMITS_BACK..HEAD`"
echo "::set-output name=added_files::`git diff --name-only --diff-filter=A HEAD~$INPUT_NUMBER_COMMITS_BACK..HEAD`"

echo "copied_files: `git diff --name-only --diff-filter=C HEAD~$INPUT_NUMBER_COMMITS_BACK..HEAD`"
echo "::set-output name=copied_files::`git diff --name-only --diff-filter=C HEAD~$INPUT_NUMBER_COMMITS_BACK..HEAD`"

echo "deleted_files: `git diff --name-only --diff-filter=D HEAD~$INPUT_NUMBER_COMMITS_BACK..HEAD`"
echo "::set-output name=deleted_files::`git diff --name-only --diff-filter=D HEAD~$INPUT_NUMBER_COMMITS_BACK..HEAD`"

echo "modified_files: `git diff --name-only --diff-filter=M HEAD~$INPUT_NUMBER_COMMITS_BACK..HEAD`"
echo "::set-output name=modified_files::`git diff --name-only --diff-filter=M HEAD~$INPUT_NUMBER_COMMITS_BACK..HEAD`"

echo "renamed_files: `git diff --name-only --diff-filter=R HEAD~$INPUT_NUMBER_COMMITS_BACK..HEAD`"
